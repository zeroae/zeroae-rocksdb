%module(package="zeroae.rocksdb.c") ratelimiter
%{
...
%rename("$ignore", notregexmatch$name="^rocksdb_ratelimiter_") "";

// Strip rocksdb_options_ from function names
%rename("%(strip:[rocksdb_ratelimiter_])s", regexmatch$name="^rocksdb_ratelimiter_") "";
