...
%cstring_input_binary(const char* start_key, size_t start_key_len);
%cstring_input_binary(const char* limit_key, size_t limit_key_len);
...
%wrap_rv(get, (rocksdb_t* db, const rocksdb_readoptions_t* options,
               const char* key,
